...
import {Grid, Row, Col, Clearfix, Popover} from 'react-bootstrap';
...
class WagonWheel extends Component {
    constructor(props) {
        super(props);
        this.state = {
            wagondata: null,
                    ...
                    if (Object.keys(this.state.wagondata[innings].length > 0)) {
                        ...
                        Object.keys(wagonBalls1).map((overs) => {
                            ...
                            if (Object.keys(wagonBalls1).length >= i) {
                                this.assignStage(mainWidth, `${stage}`, `loadedStage_${innings}_${overs}`, innings, overs);
                            }
                        })
                    }
                })
...
export default connect(mapStatetoProps, {...wagonAction /* WAGON WHEEL #WagonCreateWeb */})(WagonWheel);
